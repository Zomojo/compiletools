...
from compiletools.memoize import memoize_false
...
class diskcache:
    ...
    def _cachefile(self, filename):
        ...
        return compiletools.wrappedos.realpath(
    ...
    def _any_changes(self, filename, cachefile):
        ...
        try:
            ...
            if compiletools.wrappedos.getmtime(filename) > os.path.getmtime(cachefile):
                return True
    ...
    def __call__(self, func):
        try:
            if compiletools.dirnamer.user_cache_dir() == "None":
